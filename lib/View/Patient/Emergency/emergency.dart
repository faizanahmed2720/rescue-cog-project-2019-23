...
import 'package:untitled/View/Patient/Emergency/emergency_find_driver.dart';
...
class _EmergencyState extends State<Emergency> {
          ...
          Positioned(
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    _EmergencyFindDriver();
                    Get.to(EmergencyFindDriver(source: _sourceController.text, destination: _destinationController.text,));
                  },
  ...
  Future<void> _EmergencyFindDriver() async {
